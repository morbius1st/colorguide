...
import Colorguide from '../lib/colorguide';
...
describe('Colorguide', () => {
  ...
  describe('when the colorguide:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      // has been created
      expect(workspaceElement.querySelector('.colorguide')).not.toExist();
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.colorguide')).toExist();

        let colorguideElement = workspaceElement.querySelector('.colorguide');
        expect(colorguideElement).toExist();
